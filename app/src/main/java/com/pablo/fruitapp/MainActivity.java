...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView iv_personaje = (ImageView) findViewById(R.id.imageView_Personaje);
        TextView tv_bestScore = (TextView) findViewById(R.id.textView_BestScore);
    ...
    public void  Jugar (View view){
       ...
       if (!nombre.equals("")){
           ...
           Toast.makeText(this, "Primero tienes que escribir tu nombre", Toast.LENGTH_SHORT).show();
