...
public class MainActivity2_Nivel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nivel 4 - Restas y sumas", Toast.LENGTH_SHORT).show();

        TextView tv_nombre = (TextView) findViewById(R.id.textView_nombre);
    ...
    public void BaseDeDatos(){
        ...
        @SuppressLint("Recycle") Cursor consulta = BD.rawQuery("select * from puntaje where score = (select max(score) from puntaje)", null);
